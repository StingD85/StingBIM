...
namespace StingBIM.Data.Parameters
{
    ...
    public class ParameterDefinition
    {
        ...
        /// <summary>
        /// Gets or sets the Revit ParameterType enumeration
        ...
        /// <summary>
        /// Converts data type string to Revit ParameterType
        /// </summary>
        private static ParameterType ConvertDataTypeToParameterType(string dataType)
        {
            switch (dataType?.ToUpperInvariant())
            {
                ...
                case "AREA":
                    return ParameterType.Area;
                case "VOLUME":
                    return ParameterType.Volume;
                case "ANGLE":
                ...
                case "ELECTRICAL_CURRENT":
                    return ParameterType.ElectricalCurrent;
                case "ELECTRICAL_POTENTIAL":
                    return ParameterType.ElectricalPotential;
                case "ELECTRICAL_POWER":
                    return ParameterType.ElectricalPower;
                default:
                    return ParameterType.Text; // Default to text for unknown types
            }
        }
