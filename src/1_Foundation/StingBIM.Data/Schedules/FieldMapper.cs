...
namespace StingBIM.Data.Schedules
{
    ...
    public class FieldMapper
    {
        ...
        public SchedulableField MapParameterToField(string parameterName, ScheduleDefinition schedule)
        {
            ...
            // Check cache first
            string cacheKey = $"{schedule.CategoryId.IntegerValue}_{parameterName}";
            lock (_cacheLock)
            {
        ...
        public void ConfigureField(ScheduleField field, ScheduleFieldDefinition fieldDef)
        {
            ...
            try
            {
                ...
                // Set alignment
                field.HorizontalAlignment = MapAlignment(fieldDef.Alignment);
                
                // Set width (convert from mm to feet)
                if (fieldDef.Width > 0)
                {
                    field.Width = fieldDef.Width / 304.8; // mm to feet
                }
        ...
        /// <summary>
        /// Maps ScheduleFieldAlignment to Revit HorizontalAlignmentStyle
        /// </summary>
        private HorizontalAlignmentStyle MapAlignment(ScheduleFieldAlignment alignment)
        {
            switch (alignment)
            {
    ...
    public class FieldInfo
    {
        ...
        /// </summary>
        public bool IsBuiltIn => ParameterId.IntegerValue < 0;
