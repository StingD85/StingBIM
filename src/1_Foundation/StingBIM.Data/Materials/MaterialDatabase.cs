...
namespace StingBIM.Data.Materials
{
    ...
    public class MaterialDatabase
    {
        ...
        public async Task<int> LoadAsync(MaterialLoader loader)
        {
            ...
            try
            {
                StingBIMLogger.Info("Starting material database load...");
                ...
                StingBIMLogger.Info($"Material database loaded: {Count} materials");
                return Count;
            }
            catch (Exception ex)
            {
                StingBIMLogger.Error($"Failed to load material database: {ex.Message}", ex);
                throw;
            }
        }
        ...
        public void Clear()
        {
            lock (_lock)
            {
                ...
                StingBIMLogger.Debug("Material database cleared");
            }
        }
